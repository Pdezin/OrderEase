...
namespace Infrastructure.Contracts.Repositories.Base
{
    public interface IRepositoryBase<TEntity>
    {
        ...
        Task<TEntity?> Find(Expression<Func<TEntity, bool>> predicate, string includes = "");
        ...
        Task<QueryResult<TEntity>> Query(Expression<Func<TEntity, bool>>? predicate = null, string includes = "", int page = 0, int pageSize = 0, string orderBy = "", bool orderDesc = false);
